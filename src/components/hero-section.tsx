...
export default function HeroSection() {
    ...
    return (
        <section className="relative w-full h-[calc(100vh-171px)] min-h-[450px] overflow-hidden bg-black group flex flex-col justify-center items-center">
            ...
            <div className="absolute inset-0 z-0" ref={emblaRef}>
                <div className="flex h-full">
                    ...
                    <div className="relative flex-[0_0_100%] min-w-0 h-full bg-black flex flex-col items-center justify-center">
                        <div className="w-full max-w-5xl h-[500px] flex items-center justify-center">
                            {selectedIndex === 0 && <ParticleTextEffect words={universityWords} />}
                        </div>
                        <motion.p
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: selectedIndex === 0 ? 1 : 0, y: 0 }}
                            className="text-white/80 text-lg md:text-xl font-medium tracking-[0.2em] uppercase absolute bottom-32 z-30 text-center px-4"
                        >
